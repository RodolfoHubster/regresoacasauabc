      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          ...
          <div class="radio-group">
            ...
            <label class="radio-label"><input type="radio" name="rec-tipo" value="sin-qr"> Solo los que falló el correo</label>
          </div>
        </div>
        <div class="form-group">
          <label for="rec-mensaje" class="form-label">Mensaje personalizado (opcional)</label>
          <textarea id="rec-mensaje" class="form-input" rows="3" placeholder="Ej. Recuerda que el evento es mañana..."></textarea>
        </div>
